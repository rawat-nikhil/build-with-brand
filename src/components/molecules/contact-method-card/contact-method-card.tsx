...
export function ContactMethodCard({
  ...
  const toneModifier =
    tone === "dark" ? "contact-method-card--dark" : "contact-method-card--light";
      ...
      <div className="contact-method-card__body">
        <p
          className={cn(
            ...
            `contact-method-card__label--${tone}`
          )}
        >
          {label}
        </p>
        <p
          className={cn(
            ...
            `contact-method-card__value--${tone}`
          )}
        >
          {value}
        </p>
